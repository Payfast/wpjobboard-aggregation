...
class Config_Payfast extends Wpjb_Form_Abstract_Payment
{
    public function init()
    {
        ...
        $e->setLabel(__("Debug", "wpjobboard"));
        $e->addValidator(new Daq_Validate_InArray(array_keys($this->_env)));
        foreach ($this->_env as $k => $v) {
            $e->addOption($k, $k, $v);
        }
